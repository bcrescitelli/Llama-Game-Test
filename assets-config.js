<script>
/* ====== CATALOG: images & items ====== */
window.CATALOG = {
  llamaBase: "https://i.imgur.com/zgQ8490.png",
  hats: [
    { key:"cool_hat", name:"Cool Hat",
      thumb:"https://i.imgur.com/r6L0Yg1m.png", image:"https://i.imgur.com/r6L0Yg1.png",
  ...
  food: {
    hay:     { label:"Hay", emoji:"🌾", hunger:20, happiness:2, cost:5 },
    carrot:  { label:"Carrot", emoji:"🥕", hunger:15, happiness:5, cost:8 },
    espresso:{ label:"Espresso", emoji:"☕", hunger:0,  happiness:8, cost:10 }
  }
};

/* ====== BUILDINGS & UNLOCKS ====== */
window.BUILDINGS = [
  { key:"networking_center", name:"Networking Center", cost:40, mins:25,
    unlocks:["chat","gifting"], rareDrop:"sunglasses" },
  { key:"market", name:"Market", cost:30, mins:25,
    unlocks:["food"], rareDrop:"protein_shaker" },
  { key:"outfitters", name:"Outfitters", cost:30, mins:25,
    unlocks:["shop:hats","shop:neckwear","shop:pants","shop:shoes"], rareDrop:"cool_hat" },
  { key:"photo_booth", name:"Photo Booth", cost:25, mins:25,
    unlocks:["backgrounds"], rareDrop:"mustache" },
  { key:"gym", name:"Gym", cost:35, mins:25,
    unlocks:["buff:gym"] },
  { key:"roastery", name:"Coffee Roastery", cost:25, mins:25,
    unlocks:["buff:espresso"] },
  { key:"music_stage", name:"Music Stage", cost:40, mins:25,
    unlocks:["perk:petting"] },
  { key:"workshop", name:"Workshop", cost:30, mins:25,
    unlocks:["perk:salvage"] },
  { key:"bank", name:"Bank", cost:60, mins:25,
    unlocks:["perk:interest"] },
  { key:"arcade", name:"Arcade", cost:50, mins:25,
    unlocks:["perk:celebration"] },
  { key:"observatory", name:"Observatory", cost:35, mins:25,
    unlocks:["perk:quest"] },
  { key:"pet_shelter", name:"Pet Shelter", cost:45, mins:25,
    unlocks:["perk:pet"] },
];
</script>
